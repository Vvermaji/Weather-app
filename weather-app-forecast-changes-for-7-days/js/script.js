$(document).ready(function() {
	...
	function locateYou() {
		...
		// lat = locateMeData.latitude;
		// lon = locateMeData.longitude;
	...
	function getWeather() {
		...
		var weatherApiKey = "155a7315e0e34444bdf142731231105";
		var weatherApiCall = "https://www.weatherapi.com/"+weatherApiKey+"/"+lat+","+lon+"?units=si";
		...
		$.ajax({
			...
			success: function(weatherData) {
				...
				$(".weatherCondition").html(weatherData.current_weather.weathercode);
				...
				// $(".cloudCover").text((weatherData.current_weather.temperature*100).toFixed(2)+" %");
